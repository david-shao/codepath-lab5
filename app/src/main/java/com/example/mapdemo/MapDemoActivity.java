...
public class MapDemoActivity extends AppCompatActivity implements
	...
	private PushUtilTracker mapTracker;
    private final String CHANNEL_NAME = "android-2017";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mapTracker = new PushUtilTracker();
	}
...
//								.icon(defaultMarker));
    ...
    public void onMarkerUpdate(PushRequest pushRequest) {
        ...
        mapTracker.handleMarkerUpdates(this, pushRequest, map);
    }
